...
pub fn compile_lkql_file(file: &PathBuf, charset: &Option<String>) -> Vec<u8> {
    unsafe {
...
unsafe fn compile_node(node: &mut lkql_base_entity, env: &mut CompilationEnv) {
